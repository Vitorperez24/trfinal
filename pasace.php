...
$categoria = 'Passaros'; // Categoria específica para rações de cachorro
$subcategoria = 'Acessorios'; // Exemplo de subcategoria
...
<head>
    ...
    <title>DallasPet - Ração para Cachorro</title>
    <link rel="stylesheet" href="css/pasgaio.css">
</head>
<body>
<header>
<div class="logo">
    ...
    <script src="js/pasace.js"></script>
</body>
</html>
