...
<head>
    ...
    <title>DallasPet - Ração para Pássaro</title>
    <link rel="stylesheet" href="css/pasracoes.css">
</head>
<body>
    <header>
        <div class="logo">
        ...
        <section class="product-list">
            ...
            <div class="product-grid">
                <div class="product-card">
                    <img src="img/pasracao.PNG" alt="Ração Golden Special para Cães Adultos Sabor Frango e Carne">
                    <p>R$ 180,00</p>
    ...
    <script src="js/pasracoes.js"></script>
</body>
</html>
