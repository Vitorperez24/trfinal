...
<head>
    ...
    <title>DallasPet - Ração para Gato</title>
...
<body>
        ...
        <section class="product-list">
            ...
            <div class="product-grid">
                <div class="product-card">
                    <img src="img/gtracoes.PNG" alt="Ração Golden Special para Cães Adultos Sabor Frango e Carne">
                    <p>R$ 180,00</p>
    ...
    <script src="js/gtracoes.js"></script>
</body>
</html>
